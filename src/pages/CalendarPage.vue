<template>
  <q-page class="q-pa-sm bg-white">
    <div class="q-pa-sm q-gutter-sm row justify-center">
      <q-btn label="Previous" color="primary" @click="onPrev" outline no-caps />
      <q-btn label="Today" color="primary" @click="onToday" outline no-caps />
      <q-btn label="Next" color="primary" @click="onNext" outline no-caps />
